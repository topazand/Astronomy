...
function b(p){for(var w=g,t=0;64>t;t+=4)w[t/4]=p[t]<<24|p[t+1]<<16|p[t+2]<<8|p[t+3];for(t=16;80>t;t++)p=w[t-3]^w[t-8]^w[t-14]^w[t-16],w[t]=(p<<1|p>>>31)&4294967295;p=e[0];var E=e[1],T=e[2],na=e[3],Ac=e[4];for(t=0;80>t;t++){if(40>t)if(20>t){var Ia=na^E&(T^na);var Fb=1518500249}else Ia=E^T^na,Fb=1859775393;else 60>t?(Ia=E&T|na&(E|T),Fb=2400959708):(Ia=E^T^na,Fb=3395469782);Ia=((p<<5|p>>>27)&4294967295)+Ia+Ac+Fb+w[t]&4294967295;Ac=na;na=T;T=(E<<30|E>>>2)&4294967295;E=p;p=Ia}e[0]=e[0]+p&4294967295;e[1]=
...
ze(a,"X-YouTube-Ad-Signals"))&&(b["X-YouTube-Ad-Signals"]=ie(me(void 0)));return b}
...
"viewportWidth",Y.yt_vis="isVisible",Y.rcl="mwebInfo.responseContentLength",Y.GetSettings_rid="mwebInfo.getSettingsRequestId",Y),gi="isContinuation isNavigation kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),hi={},ii=(hi.mver="MEASUREMENT_VERSION_",hi.pis="PLAYER_INITIALIZED_STATE_",hi.yt_pt="LATENCY_PLAYER_",hi.pa="LATENCY_ACTION_",hi.yt_vst=
"VIDEO_STREAM_TYPE_",hi),ji="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");function ki(){return Q("csi_on_gel")||!!Qh(void 0).useGel}
